...
The extensions specified in this document enhance and standardize the following:
 ...
 Task planning and scheduling:: Improved specification of deadlines and
estimated time for completion. See <<deadlines>>

 Task assignment and status reporting:: The addition of VSTATUS,
(<<modifications-to-calendar-components>>) allows for more detailed
